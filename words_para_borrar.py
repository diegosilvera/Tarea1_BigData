...
print("------------H----------------")
# Estructura del comando UNIX: python words_para_borrar.py <archivo1> <num_palabras_archivo1> <archivo2> <num_palabras_archivo2 <archivo3> <num_palabras_archivo3>
...
# 0 8 * * 0 /Tarea1_BigData python words_para_borrar.py reut2-000.sgm 2 reut2-004.sgm 1 reut2-006.sgm 4